...
function filtosNomes() {
    ...
    return valor == "valor_FOB"
        ? "Valor Fob"
        : valor == "total_registros"
        ? "Total Registros"
        : valor == "total_kg_liquido"
        ? "Total Kg Liquido"
        : "Valor Agregado";
}
                ...
                y: {
                    ...
                    ticks: {
                        ...
                        callback: function (value) {
                            if (metricaSelecionada === "total_kg_liquido") {
                                if (value >= 1_000_000_000) {
                                    return (value / 1_000_000_000).toFixed(1).replace(".", ",") + "B kg";
                                } else if (value >= 1_000_000) {
                                    return (value / 1_000_000).toFixed(1).replace(".", ",") + "M kg";
                                } else if (value >= 1_000) {
                                    return (value / 1_000).toFixed(1).replace(".", ",") + "K kg";
                                }
                                return value + " kg";
                            } else {
                                if (value >= 1_000_000_000) {
